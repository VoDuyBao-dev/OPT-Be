...
import com.example.tutorsFinderSystem.dto.request.AdminRejectTutorRequest;
...
public class AdminTutorController {
    ...
    public ResponseEntity<ApiResponse<Void>> rejectTutor(
            @PathVariable Long tutorId,
            @Valid @RequestBody AdminRejectTutorRequest request) {
        adminTutorService.rejectTutor(tutorId, request.getReason());
